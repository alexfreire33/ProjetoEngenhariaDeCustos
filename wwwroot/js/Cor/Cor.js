        ...
        try {
            ...
            for (var a = 0; a < jsonListaPadrao.length; a++) {
                ...
                jQuery("#listagemItem tbody").append("\
                    <tr>\
                        <td><font>" + jsonListaPadrao[a]['CodCores'] + "</font></td>\
                        <td><font>" + jsonListaPadrao[a]['NomeCores'] + "</font></td>\
                        <td class='center'>\
...
jQuery("body").on("click", ".item", function () {
    ...
    jQuery("#cor_CodCores").val(itemFiltrado.CodCores);//coloca no hidden o codigo a ser editado
...
jQuery("body").on("click", ".valores_deletar", function () {
    ...
    swal({
        ...
        function () {
            ...
            jQuery("#cor_CodCores").val(itemFiltradoParaDelete.CodCores);//coloca no hidden o codigo a ser editado
