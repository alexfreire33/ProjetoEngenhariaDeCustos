        ...
        try {
            ...
            for (var a = 0; a < jsonListaPadrao.length; a++) {
                ...
                jQuery("#listagemItem tbody").append("\
                    <tr>\
                        <td><font>" + jsonListaPadrao[a]['CodTiposLevantamento'] + "</font></td>\
                        <td><font>" + jsonListaPadrao[a]['NomeTiposLevantamento'] + "</font></td>\
                        <td class='center'>\
...
jQuery("body").on("click", ".item", function () {
    ...
    jQuery("#tipoLevantamento_CodTiposLevantamento").val(itemFiltrado.CodTiposLevantamento);//coloca no hidden o codigo a ser editado
...
jQuery("body").on("click", ".valores_deletar", function () {
    ...
    swal({
        ...
        function () {
            ...
            jQuery("#tipoLevantamento_CodTiposLevantamento").val(itemFiltradoParaDelete.CodTiposLevantamento);//coloca no hidden o codigo a ser editado
