        ...
        try {
            ...
            for (var a = 0; a < jsonListaPadrao.length; a++) {
                ...
                jQuery("#listagemItem tbody").append("\
                    <tr>\
                        <td><font>" + jsonListaPadrao[a]['CodGrupoServico'] + "</font></td>\
                        <td><font>" + jsonListaPadrao[a]['NomeGrupoServico'] + "</font></td>\
                        <td class='center'>\
...
jQuery("body").on("click", ".item", function () {
    ...
    jQuery("#grupoDeServico_CodGrupoServico").val(itemFiltrado.CodGrupoServico);//coloca no hidden o codigo a ser editado
...
jQuery("body").on("click", ".valores_deletar", function () {
    ...
    swal({
        ...
        function () {
            ...
            jQuery("#grupoDeServico_CodGrupoServico").val(itemFiltradoParaDelete.CodGrupoServico);//coloca no hidden o codigo a ser editado
