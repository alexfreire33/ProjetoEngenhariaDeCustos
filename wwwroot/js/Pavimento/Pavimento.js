        ...
        try {
            ...
            for (var a = 0; a < jsonListaPadrao.length; a++) {
                ...
                jQuery("#listagemItem tbody").append("\
                    <tr>\
                        <td><font>" + jsonListaPadrao[a]['CodPavimentos'] + "</font></td>\
                        <td><font>" + jsonListaPadrao[a]['NomePavimentos'] + "</font></td>\
                        <td class='center'>\
...
jQuery("body").on("click", ".item", function () {
    ...
    jQuery("#pavimento_CodPavimentos").val(itemFiltrado.CodPavimentos);//coloca no hidden o codigo a ser editado
...
jQuery("body").on("click", ".valores_deletar", function () {
    ...
    swal({
        ...
        function () {
            ...
            jQuery("#pavimento_CodPavimentos").val(itemFiltradoParaDelete.CodPavimentos);//coloca no hidden o codigo a ser editado
