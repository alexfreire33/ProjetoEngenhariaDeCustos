        ...
        try {
            ...
            for (var a = 0; a < jsonListaPadrao.length; a++) {
                ...
                jQuery("#listagemItem tbody").append("\
                    <tr>\
                        <td><font>" + jsonListaPadrao[a]['CodMateriaPrima'] + "</font></td>\
                        <td><font>" + jsonListaPadrao[a]['NomeMateriaPrima'] + "</font></td>\
                        <td class='center'>\
...
jQuery("body").on("click", ".item", function () {
    ...
    jQuery("#materiaPrima_CodMateriaPrima").val(itemFiltrado.CodMateriaPrima);//coloca no hidden o codigo a ser editado
...
jQuery("body").on("click", ".valores_deletar", function () {
    ...
    swal({
        ...
        function () {
            ...
            jQuery("#materiaPrima_CodMateriaPrima").val(itemFiltradoParaDelete.CodMateriaPrima);//coloca no hidden o codigo a ser editado
