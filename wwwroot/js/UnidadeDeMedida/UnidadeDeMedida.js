        ...
        try {
            ...
            for (var a = 0; a < jsonListaPadrao.length; a++) {
                ...
                jQuery("#listagemItem tbody").append("\
                    <tr>\
                        <td><font>" + jsonListaPadrao[a]['CodUnidadeMedida'] + "</font></td>\
                        <td><font>" + jsonListaPadrao[a]['NomeUnidadeMedida'] + "</font></td>\
                        <td class='center'>\
...
jQuery("body").on("click", ".item", function () {
    ...
    jQuery("#unidadeDeMedida_CodUnidadeMedida").val(itemFiltrado.CodUnidadeMedida);//coloca no hidden o codigo a ser editado
...
jQuery("body").on("click", ".valores_deletar", function () {
    ...
    swal({
        ...
        function () {
            ...
            jQuery("#unidadeDeMedida_CodUnidadeMedida").val(itemFiltradoParaDelete.CodUnidadeMedida);//coloca no hidden o codigo a ser editado
