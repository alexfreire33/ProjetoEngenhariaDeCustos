        ...
        try {
            ...
            for (var a = 0; a < jsonListaPadrao.length; a++) {
                ...
                jQuery("#listagemItem tbody").append("\
                    <tr>\
                        <td><font>" + jsonListaPadrao[a]['CodFabricantes'] + "</font></td>\
                        <td><font>" + jsonListaPadrao[a]['NomeFabricantes'] + "</font></td>\
                        <td class='center'>\
...
jQuery("body").on("click", ".item", function () {
    ...
    jQuery("#fabricante_CodFabricantes").val(itemFiltrado.CodFabricantes);//coloca no hidden o codigo a ser editado
...
jQuery("body").on("click", ".valores_deletar", function () {
    ...
    swal({
        ...
        function () {
            ...
            jQuery("#fabricante_CodFabricantes").val(itemFiltradoParaDelete.CodFabricantes);//coloca no hidden o codigo a ser editado
