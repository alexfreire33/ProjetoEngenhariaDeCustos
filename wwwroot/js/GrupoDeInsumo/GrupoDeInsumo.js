        ...
        try {
            ...
            for (var a = 0; a < jsonListaPadrao.length; a++) {
                ...
                jQuery("#listagemItem tbody").append("\
                    <tr>\
                        <td><font>" + jsonListaPadrao[a]['CodGrupoInsumo'] + "</font></td>\
                        <td><font>" + jsonListaPadrao[a]['NomeGrupoInsumo'] + "</font></td>\
                        <td class='center'>\
...
jQuery("body").on("click", ".item", function () {
    ...
    jQuery("#grupoDeInsumo_CodGrupoInsumo").val(itemFiltrado.CodGrupoInsumo);//coloca no hidden o codigo a ser editado
...
jQuery("body").on("click", ".valores_deletar", function () {
    ...
    swal({
        ...
        function () {
            ...
            jQuery("#grupoDeInsumo_CodGrupoInsumo").val(itemFiltradoParaDelete.CodGrupoInsumo);//coloca no hidden o codigo a ser editado
