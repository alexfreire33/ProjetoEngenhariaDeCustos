        ...
        try {
            ...
            for (var a = 0; a < jsonListaPadrao.length; a++) {
                ...
                jQuery("#listagemItem tbody").append("\
                    <tr>\
                        <td><font>" + jsonListaPadrao[a]['CodPosicao'] + "</font></td>\
                        <td><font>" + jsonListaPadrao[a]['NomePosicao'] + "</font></td>\
                        <td class='center'>\
...
jQuery("body").on("click", ".item", function () {
    ...
    jQuery("#posicao_CodPosicao").val(itemFiltrado.CodPosicao);//coloca no hidden o codigo a ser editado
...
jQuery("body").on("click", ".valores_deletar", function () {
    ...
    swal({
        ...
        function () {
            ...
            jQuery("#posicao_CodPosicao").val(itemFiltradoParaDelete.CodPosicao);//coloca no hidden o codigo a ser editado
