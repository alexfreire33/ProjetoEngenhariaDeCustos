        ...
        try {
            ...
            for (var a = 0; a < jsonListaPadrao.length; a++) {
                ...
                jQuery("#listagemItem tbody").append("\
                    <tr>\
                        <td><font>" + jsonListaPadrao[a]['CodAmbienteBasico'] + "</font></td>\
                        <td><font>" + jsonListaPadrao[a]['NomeAmbienteBasico'] + "</font></td>\
                        <td class='center'>\
...
jQuery("body").on("click", ".item", function () {
    ...
    jQuery("#ambienteBasico_CodAmbienteBasico").val(itemFiltrado.CodAmbienteBasico);//coloca no hidden o codigo a ser editado
...
jQuery("body").on("click", ".valores_deletar", function () {
    ...
    swal({
        ...
        function () {
            ...
            jQuery("#ambienteBasico_CodAmbienteBasico").val(itemFiltradoParaDelete.CodAmbienteBasico);//coloca no hidden o codigo a ser editado
