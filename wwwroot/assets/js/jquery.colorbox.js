...
(function ($, document, window) {
	...
	defaults = {
		...
		next: "próx",
		close: "fechar",
		xhrError: "Falha no carregamento do conteúdo",
		imgError: "Falha no carregamento da imagem",
	...
	function appendHTML() {
		if (!$box && document.body) {
			...
			$content = $tag(div, "Content").append(
				...
				$prev = $('<button type="button"/>').attr({id:prefix+'Anterior'}),
				$next = $('<button type="button"/>').attr({id:prefix+'Pr\u00f3ximo'}),
